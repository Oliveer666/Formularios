...
<div class="container-fluid">
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="Select_Pagos.php">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" href="Insert_Ciudades.php">
    ...
    <form method="post" action="controladores/ciudades/base_de_datos_select_insert_city.php">
        <div>
        <label>Nombre</label>
