...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="Index.html">SEMILLEROS</a>
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" href="Registrar.php">
    ...
    <section class="py-2 text-center container">
        <div class="row py-lg-3">
            <div class="col-lg-50 col-md-15 mx-auto">
                <h1 class="fw-light">REGISTRO DE PROYECTO</h1>
            </div>
        </div>
        <form class="col-lg-7 col-md-15 mx-auto" method="post" action="controladores/BD_Insert.php">
            <div class="py-3">
            ...
            <div class="py-3">
                ...
                <select class="form-control" name="facultad" required>
                    ...
                    <?php
                        include "controladores/BD_Datos.php";
                    ?>
                </select>
            </div>
